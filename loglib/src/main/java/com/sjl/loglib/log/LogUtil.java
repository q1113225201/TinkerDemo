...
public class LogUtil {
    ...
    public static String LOG_FILEPATH = Environment.getExternalStorageDirectory() + "/secondlock/LogUtil/";// 本类输出的日志文件名称
    public static String LOG_FILEPATH_RELEASE = "/data/data/com.dsm.secondlock/cache/LogUtil/";// 本类输出的日志文件名称
